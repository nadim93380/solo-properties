        ...
        <div>
            <li className="flex flex-col py-6 sm:flex-row sm:justify-between">
                <div className="flex w-full space-x-2 sm:space-x-4">
                    {/* <img className=" object-cover w-24 h-20 sm:w-32 sm:h-32 dark:border- rounded outline-none dark:bg-gray-500" src={property.image} alt="Polaroid camera" /> */}
                    <img src={property.image} className="w-24 h-20 md:w-44 md:h-28 rounded-lg object-cover  " alt="" />
                    <div className="flex flex-col justify-between w-full pb-4">
                        <div className="flex justify-between w-full pb-2 space-x-2">
                            <div className="space-y-1">
                                <h3 className="text-lg font-semibold leading-snug sm:pr-8">{property.estate_title}</h3>
                                <p className="text-sm dark:text-gray-600">{property.segment_name}</p>
                            </div>
